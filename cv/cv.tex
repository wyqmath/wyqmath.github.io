...
\begin{document}
	...
	\begin{enumerate}[noitemsep, topsep=0pt, partopsep=0pt, parsep=0pt, leftmargin=*, label={[\arabic*]}]
		...
		\item Wang, X., \textbf{Wang, Y.*}, Xu, L., et al. (2025). Octopus Inspired Optimization (OIO): A Hierarchical Framework for Navigating Protein Fitness Landscapes. \textit{In 2024 IEEE International Conference on Bioinformatics and Biomedicine (BIBM)}. IEEE. (CCF-B, Co-first author).
